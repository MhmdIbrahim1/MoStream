...
import com.lagradost.cloudstream3.plugins.PluginManager.loadDefaultPlugins
...
//    }
        ...
        ioSafe { mainPluginsLoadedEvent.invoke(loadDefaultPlugins(this@MainActivity))}
            ...
            when (resource) {
                ...
                is Resource.Success -> {
                    ...
                    showPreviewPopupDialog().apply {
                        ...
                        // favorite status icon in the bottom dialog in library
